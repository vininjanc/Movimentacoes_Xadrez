...
1. Entrada
    Definir Variáveis: NN (Nível Novato): Torre, Bispo e Rainha && NA (Nível Aventureiro): Cavalo
...
2. Processamento
    Qual estrutura usar? NN: While, Do-While e For && NA: Loops Aninhados
    While: Torre
    Do-While: Bispo
    For: Rainha
...
3. Saída
    NN: As saídas devem seguir o padrão: printf("Cima\n");, printf("Baixo\n");, printf("Esquerda\n");, printf("Direita\n");, printf("Cima Esquerda\n"); printf("Direita\n");
        Vou separar cada peça em um bloco para enfatizar qual foi o movimento de cada uma.
    NA: Movimento do Cavalo ("Baixo", "Baixo", "Esquerda"), utilizando o comando printf.
...
int main(){
    ...
    int t = 1, b = 1, r = 1, c = 1; //Coloquei a letra inicial de cada peça como variável
    ...
    while (c--)
    {
        for (int i = 0; i < 2; i++)
        {
            printf("Baixo\n"); //Imprime casa para baixo 2 vezes
        }
        printf("Esquerda\n");
    }
